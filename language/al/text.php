...
$hesklang['int_error']='Gabim i brendshëm';
$hesklang['no_trackID']='No tracking ID';
$hesklang['status_not_valid']='Status not valid';
$hesklang['trackID_not_found']='ID nuk është gjetur';
$hesklang['select_priority']='Ju lutem zgjidhni prioritetin e çështjes';
$hesklang['ticket_not_found']='Çështja nuk është gjetur! Ju lutem sigurohuni të keni vendosur ID e saktë!';
$hesklang['no_selected']='No tickets selected, nothing to change';
$hesklang['id_not_valid']='Kjo nuk është një ID e vlefshme';
...
$hesklang['enter_valid_email']='Ju lutem vendosni një adresë të vlefshme emaili';
...
$hesklang['passwords_not_same']='Fjalëkalimet e vendosura nuk përputhen!';
...
$hesklang['enter_your_name']='Ju lutem plotësoni emrin tuaj!';
$hesklang['enter_message']='Ju lutem vendosni mesazhin tuaj';
$hesklang['sel_app_cat']='Ju lutem zgjidhni kategorinë e duhur';
$hesklang['sel_app_priority']='Please select the appropriate priority';
$hesklang['enter_ticket_subject']='Ju lutem vendosni emërtimin e çështjes';
...
$hesklang['view_ticket']='Shikoni çështjet';
...
$hesklang['ticket_status']='Gjëndja e cështjes';
$hesklang['replies']='Përgjigjet';
$hesklang['date']='Data';
$hesklang['email']='Email';
$hesklang['ip']='IP';
$hesklang['message']='Përshkrimi';
$hesklang['add_reply']='Shtoni përgjigjen';
...
$hesklang['submit_reply']='Dërgoni përgjigjen';
$hesklang['support_panel']='Support panel';
$hesklang['ticket_trackID']='ID e çështjes';
$hesklang['c2c']='Klikoni këtu për të vazhduar';
...
$hesklang['cat_renamed_to']='Selected category has been successfully updated!';
...
$hesklang['manage_clients']='Manage clients';
$hesklang['manage_contracts']='Manage contracts';
...
$hesklang['req_marked_with']='Fushat e detyrueshme janë shënuar me yll (*)';
$hesklang['real_name']='Emri i vërtetë';
$hesklang['sign_extra']='Linket do të jenë të klikueshme.';
...
$hesklang['update_profile']='Përditësoni profilin tuaj';
...
$hesklang['profile_updated_success']='Ky profil është update-uar në mënyrë të suksesshme!';
...
$hesklang['end_ticket']='--- Fundi i cështjes ---';

// CUSTOMER INTERFACE
$hesklang['your_ticket_been']='Cështja juaj është';
$hesklang['submit_ticket']='Rregjistroni një çështje';
$hesklang['sub_ticket']='Rregjistroni një çështje';
$hesklang['before_submit']='Përpara rregjistrimit të çështjes kini parasysh udhëzimet e mëposhtme';
$hesklang['all_info_in']='Duhet të jenë plotesuar të gjitha të dhënat e nevojshme';
$hesklang['all_error_free']='Të dhënat duhet të jenë plotësuar saktë dhe pa gabime';
$hesklang['we_have']='Ne kemi';
$hesklang['recorded_ip']='recorded as your IP Address';
$hesklang['recorded_time']='rregjistruar kohën e rregjistrimit';
$hesklang['save_changes']='Save changes';
$hesklang['reply_submitted']='Reply submitted';
$hesklang['reply_submitted_success']='Përgjigjja juaj ndaj çështjes është rregjistruar me sukses';
$hesklang['view_your_ticket']='Shikoni çështjen tuaj';
$hesklang['ticket_submitted']='Çështja u rregjistrua';
$hesklang['ticket_submitted_success']='Çështja juaj është rregjistruar me sukses!ID e çështjes';
...
$hesklang['open']='E re';
$hesklang['wait_staff_reply']='Ju lutem, prisni përgjigjen nga stafi i suportit';
$hesklang['wait_cust_reply']='Prisni përgjigjen nga klienti';
$hesklang['replied']='Përgjigjur';
$hesklang['closed']='Zgjidhur'; // Ticket has been RESOLVED
$hesklang['last_replier']='Përgjigjja e fundit';
$hesklang['staff']='Stafi';
$hesklang['customer']='Klienti';
...
$hesklang['attachments']='Bashkëngjit dokumenta';
$hesklang['fill_all']='Plotësoni fushat e detyrueshme';
$hesklang['file_too_large']='Your file %s is too large';
$hesklang['created_on']='Krijuar';
...
$hesklang['sec_img']='Siguria e imazhit';
$hesklang['q_wrng']='Përgjigje e gabuar kundër SPAM-eve';
$hesklang['sec_miss']='Ju lutem vendosni numrin e sigurisë';
$hesklang['sec_wrng']='Numër i gabuar sigurie';
...
$hesklang['forgot_tid']='Harruat ID e çështjes?';
$hesklang['tid_send']='Më dërgoni ID e çështjeve';
$hesklang['tid_not_found']='Nuk ka asnjë çështje të hapur për këtë përdorues';
$hesklang['tid_sent']='Kontrollo ID';
$hesklang['tid_sent2']='Ju ka ardhur një email me të dhënat e çështjes';
$hesklang['check_spambox']='Sigurohuni të kontrolloni emailet që ndodhen ne Junk!';
...
$hesklang['sub_support']='RREGJISTRONI NJË ÇËSHTJE';
$hesklang['submit_tick']='Rregjistroni një çështje';
$hesklang['hello']='Përshëndetje, ';
$hesklang['open_ticket']='Submit a new issue to a department';
$hesklang['view_existing']='SHIKONI ÇËSHTJET EKZISTUESE';
$hesklang['vet']='View tickets you submitted in the past';
$hesklang['enter_user']='Please enter your username';
$hesklang['remember_user']='Rregjistroni emrin e përdoruesit';
...
$hesklang['no_tickets_open']='No tickets found matching your criteria';
...
$hesklang['main_page']='Faqja kryesore';
$hesklang['menu_users']='Users';
$hesklang['menu_cat']='Configurations';		//'Categories';
$hesklang['menu_profile']='Profile';
$hesklang['menu_contracts']='Contracts';
$hesklang['menu_kb']='Help';				//'Knowledgebase'; // Admin MENU item
...
$hesklang['sc']='Artikujt e sugjeruar';
...
$hesklang['cwin']='Mbyllni dritaren';
...
$hesklang['q_miss']='Ju lutem përgjigjuni pyetjes kundër SPAM-eve';
...
$hesklang['pinfo']='Informacionet e Profilit';
...
$hesklang['rfm']='Mungon informacioni i kërkuar:';
...
$hesklang['tislock2']='Kjo çështje është mbyllur dhe nuk mund të modifikohet.';
$hesklang['nsfo']='Nuk u gjet asnjë artikull i rëndësishëm.';
$hesklang['elocked']='Kjo çështje është fshirë ose mbyllur.';
...
$hesklang['password_not_valid']='Fjalëkalimi duhet të jetë 5 karaktere i gjatë';
...
$hesklang['pcer']='Ju lutem plotësoni formën e mëposhtme:';
$hesklang['seqid']='Numri i çështjes';
$hesklang['close_action']='Çështje e zgjidhur'; // Close ACTION
...
$hesklang['yhbb']="Ju jeni ç'loguar nga sistemi për %s minuta për shkak të dështimeve në logim .";
$hesklang['pwdst']='Siguria e fjalëkalimit';
$hesklang['tid_mail']='Mos u shqetësoni! Vendosni <b>adresën e email-it</b> dhe ne do tju dërgojme ID e çështjes:';
$hesklang['rem_email']='Rregjistroni adresën time të email-it';
$hesklang['eytid']='Vendosni ID e çështjes.';
$hesklang['enmdb']='The email address you entered doesn\'t match the one in the database for this ticket ID.';
$hesklang['confemail']='Konfirmoni Email-in';
$hesklang['confemail2']='Ju lutem konfirmoni adresën e email-it';
$hesklang['confemaile']='Adresat e emailit nuk janë të njëjta';
$hesklang['taso3']='Asenjuar:';
$hesklang['sec_enter']='Vendosni numrin që shikoni në figurën e mëposhtme.';
$hesklang['reload']='Ngarko imazhin';
$hesklang['verify_q']='Mbrojtja ndaj SPAM-ve:'; // For anti-spam question
$hesklang['verify_i']='Mbrojtja ndaj SPAM-ve:'; // For anti-spam image (captcha)
$hesklang['admin_login']='Staff login';
$hesklang['vrfy']='Test passed';
$hesklang['last_update']='Modifikuar';
...
$hesklang['select']='Klikoni për të përzgjedhur:';
...
$hesklang['chdp2']='Ju lutem ndryshoni fjalëkalimin!';
$hesklang['security']='Siguria';
...
$hesklang['in_progress']='Në progres';
$hesklang['on_hold']='Në pritje';
...
$hesklang['noopen']='Nuk ka asnjë çështje të hapur për këtë përdorues.';
$hesklang['maxopen']='Ju keni arritur numrin maksimal të çështjeve të hapura(%d of %d). Ju lutem prisni sa te zgjidhen çështjet ekzistuese, përpara se të hapni cështje të reja.';
...
$hesklang['attpri']='Ju nuk keni të drejta mbi dokumentin e bashkëngjitur.';
...
$hesklang['tme']='Cështja %s është bashkuar me këtë çështje (%s).';
$hesklang['tme1']='Çështja %s është bashkuar me këtë çështje %s';
$hesklang['tme2']='Për të aksesuar çështjen %s ju lutem vendosni adresën e email-it.';
...
$hesklang['ful']='Limiti i fileve për të upload-uar';
$hesklang['ufl']='Ju mund të shkarkoni filet që mbarojnë me:';
$hesklang['nat']='Maximum number of attachments:';
$hesklang['mfs']='Maksimumi i fileve që mund të bashkëngjiten:';
...
$hesklang['didum']='Nënkuptoni %s?'; // Did you mean someone@gmail.com?
$hesklang['yfix']='Po, rregullojeni';
$hesklang['nole']='Jo, lëreni sic është';
$hesklang['sconfe2']='Show a &quot;Confirm email&quot; field on the submit a ticket form';
$hesklang['oln']='Old name:';
$hesklang['nen']='New name:';
$hesklang['use_form_below']='<i>Kjo formë do të përdoret për rregjistrimin e çështjeve. Fushat me yll(*) janë të detyrueshme për tu plotësuar</i>';
...
$hesklang['sdemo']="Ruajtja e të dhënave është c'aktivizuar në gjëndjen DEMO";
...
$hesklang['attdel']='Ky dokument është fshirë nga serveri dhe nuk mund të shkarkohet';
...
$hesklang['wrepo']='Ju lutem shkruani arsyen e rihapjes së cështjes.';
...
$hesklang['maxpost']='Keni vendosur më shumë të dhëna nga cmund të mbajë serveri!.<br /><br />Ju lutem mundohuni të rregjistroni sërisht cështjen me më pak të dhëna';
...
$hesklang['visual_challenge']='Pajme vizuale';
$hesklang['audio_challenge']='Pamje audio';
$hesklang['refresh_btn']='Pamje e re';
$hesklang['instructions_visual']='Vendosni dy fjalët e para:';
$hesklang['instructions_context']='Shkruani fjalët brenda kutisë:';
$hesklang['instructions_audio']='Shkruani cfarë dëgjuat:';
$hesklang['help_btn']='Ndihmë';
$hesklang['play_again']='Luani serisht audio';
$hesklang['cant_hear_this']='Shkarkoni file-in si MP3';
$hesklang['incorrect_try_again']='Gabim! Provoni përsëri!';
$hesklang['image_alt_text']='reCAPTCHA challenge image';
$hesklang['recaptcha_error']='Përgjigje e gabuar për mbrojtjen ndaj SPAM-eve, ju lutem provoni përseri.';
...
$hesklang['cat_pri_info']='Your customers are allowed to select priority, so category priority will be ignored. <br /> To use category priority instead, turn OFF the following feature in HESK settings:';
...
$hesklang['signature_max']='Nënshkrimi (max 1000 karaktere)';
$hesklang['signature_long']='Nënshkrimi i përdoruesit është shumë i gjatë!Ju lutem vendosni një përshkrim max 1000 karaktere!';
$hesklang['ip_whois']='IP whois';
$hesklang['ednote']='Edit note message';
$hesklang['ednote2']='Note message saved';
$hesklang['perm_deny']='Nuk ju lejohet aksesi';
...
$hesklang['aclient']='Client';
$hesklang['oon1']='Më dërgoni vetëm çështjet e hapura';
$hesklang['oon2']='Më dërgoni të gjitha çështjet';
...
$hesklang['yhbr']="Ju jeni ç'loguar nga sistemi për %s minuta për shkak të shumë përgjigjeve të dhëna në një çështje";
...
// info clients projects & contract & company
$hesklang['id']='ID';
$hesklang['contract_name']='Contract Name';
$hesklang['company']='Company';
/*$hesklang['partner']='Partner';*/
$hesklang['starting_date']='Data e fillimit';
$hesklang['ending_date']='Data e përfundimit';
$hesklang['created_by']='Created by';
$hesklang['last_modified']='Last Modification Date';
$hesklang['active']='Aktive';
$hesklang['state']='State';
$hesklang['company']='Company';
$hesklang['project']='Projekti';
$hesklang['contract']='Kontrata';
$hesklang['project_name']='Project Name';
$hesklang['manage_project']='Manage Projects';
$hesklang['manage_company']='Manage Companies';
$hesklang['manage_department']='Manage Departments';
$hesklang['dep_code']='Department Code';
$hesklang['dep_name']='Department Name';
$hesklang['dep_manager']='Department Manager';
$hesklang['project_manager']='Project Manager';
$hesklang['create_contract']='Create Contracts';
$hesklang['edit_contract']='Update Contracts';
$hesklang['create_project']='Create Projects';
$hesklang['edit_project']='Update Projects';
$hesklang['create_company']='Create Companies';
$hesklang['edit_company']='Update Companies';
$hesklang['create_company']='Create Companies';
$hesklang['create_department']='Create Departments';
$hesklang['edit_department']='Update Departments';
$hesklang['company_name']='Company Name';
$hesklang['web_page']='Web Page';
$hesklang['address']='Adresa';
$hesklang['state']='State';
$hesklang['city']='City';
$hesklang['zip_code']='Zip Code';
$hesklang['telephone']='Nr i telefonit';
$hesklang['work_position']='Pozicioni i punës';
...
$hesklang['con_removed_db']='Selected contract has been successfully removed from the database';
...
$hesklang['clear']='Fshini';
$hesklang['manage_ticket']='Manage Tickets';
$hesklang['search_id']='Kërkoni me ID';
$hesklang['search_subject']='Kërkoni me emërtim';
$hesklang['search_client']='Kërkoni me klient';
$hesklang['select_categ']='Përzgjidhni kategorinë';
$hesklang['select_status']='Përzgjidhni gjëndjen';
$hesklang['account_deactivated']="Llogaria juaj është c'aktivizuar!Ju lutem kontaktoni administratorin!";
$hesklang['wrong_pass_username']='Fjalëkalim i gabuar, provoni përseri!';
$hesklang['helpdesk_by']='Help Desk Software by ';
$hesklang['commprog']='Communication Progress';
$hesklang['wait_reply']='Prisni për përgjigjen';
