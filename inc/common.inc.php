...
function hesk_show_error($message,$title='',$append_colon=true)
{
	...
	<div class="container error">
		<img src="<?php echo HESK_PATH; ?>img/error.png" width="16" height="16" border="0" alt="" />
...
function hesk_show_success($message,$title='',$append_colon=true)
{
	...
	<div class="container success">
		<img src="<?php echo HESK_PATH; ?>img/success.png" width="16" height="16" border="0" alt="" />
		<b><?php echo $title; ?></b> <?php echo $message; ?>
	</div>
...
function hesk_show_notice($message,$title='',$append_colon=true)
{
	...
	<div class="notice container">
		<img src="<?php echo HESK_PATH; ?>img/notice.png" width="16" height="16" border="0" alt="" />
		<b><?php echo $title; ?></b> <?php echo $message; ?>
	</div>
	<?php
...
function hesk_showTopBar($page_title)
{
	...
	if ($hesk_settings['can_sel_lang'])
	{
        ...
        $str .= '<select class="form-control" name="language" onchange="this.form.submit()">';
...
function hesk_check_maintenance($dodie = true)
{
	...
	?>
	<div class="row heskTitle">
		<div class="form-inline">
			<label><img src="<?php echo HESK_PATH; ?>"/></label>
			<label class="show-heskTitle"><?php echo $hesk_settings['hesk_title']; ?></label>
			<label><img src="<?php echo HESK_PATH; ?>"/></label>
		</div>
	</div>

	<table width="100%" border="0" cellspacing="0" cellpadding="3"> <!-- start in this page end somewhere... -->
	<tr> <!--end in line 1853 -->
	<td> <!--end in line 1852 -->
...
<div class="container siteUrl-title-indexPhp">
	<div class="form-inline">
		<span><a href="<?php echo $hesk_settings['site_url']; ?>"
...
{
	?>
	<div class="container"><a href="javascript:history.go(-1)"><input type="submit" class="btn btn-default goback-btn" value="<?php echo $hesklang['back']; ?>" /></a></div> 
	<?php
}
?>
