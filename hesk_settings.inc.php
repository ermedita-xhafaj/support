<?php
// Settings file for HESK 2.6.4

// ==> GENERAL

// --> General settings
$hesk_settings['site_title']='Communication Progress Support System';
$hesk_settings['site_url']='http://localhost/support';
$hesk_settings['webmaster_mail']='t.alimadhi@localhost';
$hesk_settings['noreply_mail']='t.alimadhi@localhost';
...
// --> Help desk settings
$hesk_settings['hesk_title']='Online Support System';
...
$hesk_settings['secimg_sum']='G2G3LWHRQ9';
...
$hesk_settings['question_ask']='Which of these is an animal: bell, airplane, duck';
$hesk_settings['question_ans']='duck';
...
$hesk_settings['ticket_list']=array('id','trackid','lastchange','name','subject','status','owner','lastreplier');
...
#     DO NOT EDIT BELOW     #
#############################
$hesk_settings['hesk_version']='2.6.4';
