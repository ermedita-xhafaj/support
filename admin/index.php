...
function do_login()
{
	...
	//$result = hesk_dbQuery("SELECT * FROM `tbl_users` WHERE `user` = '".hesk_dbEscape($user)."' LIMIT 1");
...
<div class="container siteUrl-title-admin-indexPhp">
	<div class="form-inline">
		<span><a href="<?php echo $hesk_settings['site_url']; ?>" class="smaller"><?php echo $hesk_settings['site_title']; ?></a></span> &gt;
		<span><?php echo $hesklang['admin_login']; ?></span>
	</div>
</div>
	...
	<div class="form-group admin-login">	
		...
		<div class="container form-group">
			<form action="index.php" method="post" name="form1">
					...
					<div id="ad-log"><b><?php echo $hesklang['admin_login']; ?></a></b></div>
					
				</br>
				
				<div class="form-inline">
				<h4><label class="control-label" for="username-admin"><?php echo $hesklang['username']; ?>:</label></h4>
					<?php
					...
					<div class="form-inline">
					<h4><label class="control-label" for="password-admin"><?php echo $hesklang['pass']; ?>:</h4><input class="form-control" id="password-admin" type="password" name="pass" size="35" <?php if (in_array('pass',$_SESSION['a_iserror'])) {echo ' class="isError" ';} ?> />
					</div>
					<?php
				...
				else
				{
					?>
						...
						<label><input type="checkbox" name="remember_user" value="JUSTUSER" class="form-control"<?php echo $is_2; ?> /> <?php echo $hesklang['remember_user']; ?></label>
				...
				<br/><br/>
					...
					<button type="submit" class="btn btn-default" id="submit-login"><?php echo $hesklang['click_login']; ?></button>
