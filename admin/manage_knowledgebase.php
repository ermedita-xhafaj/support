...
{
	?>
	<div class="container manage-kb-title"><b><?php echo $hesklang['kb']; ?> [<a href="javascript:void(0)" onclick="javascript:alert('<?php echo hesk_makeJsString($hesklang['kb_intro']); ?>')">?</a>]</b></div>

	<!-- SUB NAVIGATION -->
	<div class="container sub-navigation-kb"><?php show_subnav(); ?></div>
	<!-- SUB NAVIGATION -->
	...
	<div class="show-cta-tree"><?php show_treeMenu(); ?></div>
	<!-- SHOW THE CATEGORY TREE -->
	
    <div class="container kb-tools-title"><?php echo $hesklang['ktool']; ?></div>
	<div class="kb-tools">
		<div class="container kb-tools-list">
			...
			<img src="../img/link.png" width="16" height="16" border="0" alt="" style="padding:3px" class="optionWhiteNbOFF" /> <a href="http://support.mozilla.com/en-US/kb/how-to-write-knowledge-base-articles" rel="nofollow" target="_blank"><?php echo $hesklang['goodkb']; ?></a>
		</div>
	</div>
...
if (!isset($_SESSION['hide']['new_article']))
{
	...
	<div class="container new-manage-kb-title"><a href="manage_knowledgebase.php" class="smaller"><b><?php echo $hesklang['kb']; ?></b></a> &gt; <?php echo $hesklang['new_kb_art']; ?></div>
	<br/>
	<!-- SUB NAVIGATION -->
	<div class="container sub-navigation-kb"><?php $catid = show_subnav('newa'); ?></div>
	<!-- SUB NAVIGATION -->
<div>
	        <?php
	        ...
	        ?>
	<div class="container new-kb-article-title"><a name="new_article"></a><?php echo $hesklang['new_kb_art']; ?></div>
	<div class="new-kb-article-form"> 
	<br/>
		<form action="manage_knowledgebase.php" method="post" name="form1" enctype="multipart/form-data">
			<div class="form-inline">
				<span class="col-sm-2"><b><?php echo $hesklang['kb_cat']; ?>:</b></span>
				<span><select class="form-control" name="catid"><?php $listBox->printMenu(); ?></select></span>
			</div>
			<br/>
			<div class="form-inline">
				<span class="col-sm-2"><b><?php echo $hesklang['kb_type']; ?>:</b></span>
				<div class="form-group">
					...
					<span><?php echo $hesklang['kb_published2']; ?></span>
					<br/><br/>
					...
					<span><?php echo $hesklang['kb_private2']; ?></span>
					<br/><br/>
					...
					<span><?php echo $hesklang['kb_draft2']; ?></span>
				</div>
			</div>
			<br/>
			<div class="form-inline">
				<span class="col-sm-2"><b><?php echo $hesklang['kb_subject']; ?>:</b></span>
				<span><input class="form-control" type="text" name="subject" size="68" maxlength="255" <?php if (isset($_SESSION['new_article']['subject'])) {echo 'value="'.$_SESSION['new_article']['subject'].'"';} ?> /></span>
			</div>
			<br/>	
			<div class="form-inline">
				<span class="col-sm-2"><b><?php echo $hesklang['opt']; ?>:</b></span>
				<label><input type="checkbox" name="sticky" value="Y" <?php if ( ! empty($_SESSION['new_article']['sticky'])) {echo 'checked="checked"';} ?> /> <i><?php echo $hesklang['sticky']; ?></i></label> [<a href="javascript:void(0)" onclick="javascript:alert('<?php echo hesk_makeJsString($hesklang['saa']); ?>')"><b>?</b></a>]
			</div>
			<br/>
			<div class="form-inline">
				<?php
				...
				$displayWarn = 'none';
				?>
				<span class="col-sm-2"><b><?php echo $hesklang['kb_content']; ?>:</b></span>
				...
				<textarea name="content" rows="25" cols="70" id="content" style="width:47.6%; height:300px"><?php if (isset($_SESSION['new_article']['content'])) {echo $_SESSION['new_article']['content'];} ?></textarea>
			</div>
			<br/>
			<div class="form-inline">
				<span class="col-sm-2"><?php echo $hesklang['kw']; ?>:</b></span>
				<div class="form-group textarea-kb">
					<span><textarea class="form-control" name="keywords" rows="3" cols="70" id="keywords"><?php if (isset($_SESSION['new_article']['keywords'])) {echo $_SESSION['new_article']['keywords'];} ?></textarea></span><br/>
					<span><?php echo $hesklang['kw1']; ?></span>
				</div>
			</div>
			<br/>
			<div class="form-inline">
			<span class="col-sm-2"><b><?php echo $hesklang['attachments']; ?></b></span>
				<div class="form-group">
					...
					<span>(<a href="Javascript:void(0)" onclick="Javascript:hesk_window('../file_limits.php',250,500);return false;"><?php echo $hesklang['ful']; ?></a>)</span>
				</div>
			</div>
			<br/>
		<div class="container">
				<div id="save-article">
					...
					<input type="submit" value="<?php echo $hesklang['kb_save']; ?>" class="btn btn-default save-article-btn" />
					<span><a href="manage_knowledgebase.php?a=manage_cat&amp;catid=<?php echo $catid; ?>"><input type="submit" value="<?php echo $hesklang['cancel']; ?>" class="btn btn-default cancel-article-btn" /></a></span>
				</div>
		</div>
	</form>
	<br/>
...
if (!isset($_SESSION['hide']['new_category']))
{
	...
	<div class="container new-manage-kb-title"><a href="manage_knowledgebase.php" class="smaller"><b><?php echo $hesklang['kb']; ?></a></b> &gt; <?php echo $hesklang['kb_cat_new']; ?></div>
	<br/>
	<!-- SUB NAVIGATION -->
	<div class="container sub-navigation-kb"><?php show_subnav('newc'); ?></div>
	<!-- SUB NAVIGATION -->
<div>
	<div class="container new-kb-category-title"><a name="new_category"></a><?php echo $hesklang['kb_cat_new']; ?></div>
	<div class="new-kb-category-form">
	<br/>
		<form action="manage_knowledgebase.php" method="post" name="form2"> 
			<div class="form-inline">
				<span class="col-sm-2"><b><?php echo $hesklang['kb_cat_title']; ?>:</b></span>
				<span><input class="form-control" type="text" name="title" size="70" maxlength="255" /></span>
			</div>
			<br/>
			<div class="form-inline">
				<span class="col-sm-2"><b><?php echo $hesklang['kb_cat_parent']; ?>:</b></span>
				<span><select class="form-control" name="parent"><?php $listBox->printMenu()?></select></span>
			</div>
			<br/>
			<div class="form-inline">
				<span class="col-sm-2"><b><?php echo $hesklang['kb_type']; ?>:</b></span>
				<div class="form-group">
					...
					<span><?php echo $hesklang['kb_cat_published']; ?></span>
					<br/><br/>
					...
					<span><?php echo $hesklang['kb_cat_private']; ?></span>
				</div>
			</div>
			<br/>
		<div class="ccontainer">
			...
			<div id="add_category">
				<input type="hidden" name="token" value="<?php hesk_token_echo(); ?>" />
				<input type="submit" value="<?php echo $hesklang['kb_cat_add']; ?>" class="btn btn-default save-category-btn" />
				<span><a href="manage_knowledgebase.php"> <input type="submit" value="<?php echo $hesklang['cancel']; ?>" class="btn btn-default cancel-category-btn" /></a><span>
			</div>
		</div>
	</form>
	<br/>
...
function list_draft() {
    ...
    <div class="container new-manage-kb-title"><a href="manage_knowledgebase.php" class="smaller"><b><?php echo $hesklang['kb']; ?></a></b> &gt; <?php echo $hesklang['kb_cat_man']; ?></div>
	<br/>
	<!-- SUB NAVIGATION -->
	<div class="container sub-navigation-kb"><?php show_subnav('',$catid); ?></div>
	<!-- SUB NAVIGATION -->
    ...
    if ($num == 0)
    {
    	echo '<div class="container">'.$hesklang['kb_no_dart'].' &nbsp; <a href="manage_knowledgebase.php?a=add_article&amp;catid='.$catid.'&amp;type=2"><br/><br/>
		<img src="../img/add_article.png" width="16" height="16" alt="'.$hesklang['kb_i_art2'].'" title="'.$hesklang['kb_i_art2'].'" border="0" style="border:none;vertical-align:text-bottom" /></a> <a href="manage_knowledgebase.php?a=add_article&amp;catid='.$catid.'&amp;type=2"><b>'.$hesklang['kb_i_art2'].'</b></a></div>';
    }
    else
    {
    	?>
	    ...
	    <div class="artd-title"><?php echo $hesklang['artd']; ?></div>
		<div align="center">
...
function list_private() {
    ...
    <div class="container new-manage-kb-title"><a href="manage_knowledgebase.php" class="smaller"><b><?php echo $hesklang['kb']; ?><b/></a> &gt; <?php echo $hesklang['kb_cat_man']; ?></div>
	<br/>
	<!-- SUB NAVIGATION -->
	<div class="container sub-navigation-kb"><?php show_subnav('',$catid); ?></div>
	<!-- SUB NAVIGATION -->
    ...
    if ($num == 0)
    {
    	echo '<div class="container">'.$hesklang['kb_no_part'].' &nbsp; <a href="manage_knowledgebase.php?a=add_article&amp;catid='.$catid.'&amp;type=1"><br/><br/>
		<img src="../img/add_article.png" width="16" height="16" alt="'.$hesklang['kb_i_art2'].'" title="'.$hesklang['kb_i_art2'].'" border="0" style="border:none;vertical-align:text-bottom" /></a> <a href="manage_knowledgebase.php?a=add_article&amp;catid='.$catid.'&amp;type=1"><b>'.$hesklang['kb_i_art2'].'</b></a></div>';
    }
    else
    {
    	?>
        <div style="float:right">
	     ...
	     <div class="container"><h3 style="padding-bottom:5px;">&raquo; <?php echo $hesklang['artp']; ?></h3></div>
...
function edit_article()
{
	...
	?>
	 ...
	 <div class="container new-manage-kb-title"><a href="manage_knowledgebase.php" class="smaller"><b><?php echo $hesklang['kb']; ?></a></b> &gt;
    <a href="manage_knowledgebase.php?a=manage_cat&amp;catid=<?php echo $catid; ?>" class="smaller"><?php echo $hesklang['kb_cat_man']; ?></a> &gt; <?php echo $hesklang['kb_art_edit']; ?></div>
...
<div>
	<?php echo '<div class="container kb_art_edit_title">' .$hesklang['kb_art_edit'] .'</div>'; ?>
	...
	<form action="manage_knowledgebase.php" method="post" name="form1" enctype="multipart/form-data">
		<div class="form-inline">
			<span class="col-sm-2"><b><?php echo $hesklang['kb_cat']; ?>:</b></span>
			<span><select name="catid"><?php $listBox->printMenu()?></select></span>
		</div>
		<br/>
		<div class="form-inline">
			<span class="col-sm-2"><b><?php echo $hesklang['kb_type']; ?>:</b></span>
			<div class="form-group">
				...
				<span><?php echo $hesklang['kb_published2']; ?></span><br />
				<br/>
				...
				<span><?php echo $hesklang['kb_private2']; ?></span><br />
				<br/>
		...
		<div class="form-inline">
			<span class="col-sm-2"><b><?php echo $hesklang['kb_subject']; ?>:</b></span>
			<span><input class="form-control" type="text" name="subject" size="70" maxlength="255" value="<?php echo $article['subject']; ?>" /></span>
		</div>
		<br/>
		<div class="form-inline">
			<span class="col-sm-2"><b><?php echo $hesklang['opt']; ?>:</b></span>
		...
		<div class="form-inline">
			...
			<textarea name="content" rows="25" cols="70" id="content" style="width:48.9%; height:300px"><?php echo $article['content']; ?></textarea>
		</div>
		<br/>
		<div class="form-inline">
			<span class="col-sm-2"><?php echo $hesklang['kw']; ?>:</b></span>
			<div class="form-group textarea-kw">
				<span><textarea class="form-control" name="keywords" rows="3" cols="70" id="keywords"><?php echo $article['keywords']; ?></textarea></span><br/>
				<span><?php echo $hesklang['kw1']; ?></span>
			</div>
		</div>
		<br/>
		...
		<div class="container">
			...
			<input type="hidden" name="token" value="<?php hesk_token_echo(); ?>" />
			<input type="submit" value="<?php echo $hesklang['kb_save']; ?>" class="btn btn-default save-article-btn" />
			<a href="manage_knowledgebase.php?a=manage_cat&amp;catid=<?php echo $catid; ?>"><input type="submit" value="<?php echo $hesklang['cancel']; ?>" class="btn btn-default cancel-article-btn" /></a>
		</div>
	</form>
	<br/>
	</div>	
    ...
    <div class="container revision-history-title"><?php echo $hesklang['revhist']; ?></div>
...
function manage_category() {
	...
	?>
     ...
     <div class="container manage-kb-category-title"><a href="manage_knowledgebase.php" class="smaller"><b><?php echo $hesklang['kb']; ?></b></a> &gt; <?php echo $hesklang['kb_cat_man']; ?></div>
    ...
    ?>
     ...
     <div class="container category-kb"><?php echo $hesklang['category']; ?>: <span class="black"><?php echo $this_cat['name']; ?></span></div>
    ...
    if ($num == 0)
    {
		...
		<a href="manage_knowledgebase.php?a=add_article&amp;catid='.$catid.'"><img src="../img/add_article.png" width="16" height="16" alt="'
		.$hesklang['kb_i_art2'].'" title="'.$hesklang['kb_i_art2'].'" border="0" style="border:none;vertical-align:text-bottom" /></a>' 
		.'<a href="manage_knowledgebase.php?a=add_article&amp;catid='.$catid.'"><b>'.$hesklang['kb_i_art2'].'</b></a></div>';
    }
    else
    {
        ...
        <div class="container insertArticle">
	     ...
	     <div class="container kb_cat_art_title"><?php echo $hesklang['kb_cat_art']; ?></div>
	...
	<div class="container category-settings-title"><?php echo $hesklang['catset']; ?></div>
	...
	<br/>
		<form action="manage_knowledgebase.php" method="post" name="form1" onsubmit="Javascript:return hesk_deleteIfSelected('dodelete','<?php echo hesk_makeJsString($hesklang['kb_delcat']); ?>')">
			<div class="form-inline">
				<span class="col-sm-2"><b><?php echo $hesklang['kb_cat_title']; ?>:</b></span>
				<span><input class="form-control" type="text" name="title" size="70" maxlength="255" value="<?php echo $this_cat['name']; ?>" /></span>
			</div>
			<br/>
			<div class="form-inline">
				<span class="col-sm-2"><b><?php echo $hesklang['kb_cat_parent']; ?>:</b></span>
			...
			<div class="form-inline">
				...
				<div class="form-group">
					...
					<span><?php echo $hesklang['kb_cat_published']; ?></span><br/><br/>
	...
	<br/>
		<div class="col-sm-6 col-sm-offset-6">
	        ...
	        <input type="hidden" name="token" value="<?php hesk_token_echo(); ?>" />
	        <input type="hidden" name="catid" value="<?php echo $catid; ?>" /><input type="submit" value="<?php echo $hesklang['save_changes']; ?>" class="btn btn-default save-cat-changes-btn" />
		</div>
	</form>
...
function show_treeMenu() {
	...
	<script src="<?php echo HESK_PATH; ?>inc/treemenu/TreeMenu_v25.js" language="JavaScript" type="text/javascript"></script>
	 ...
	 <div class="container kbstruct-title"><?php echo $hesklang['kbstruct']; ?></div>

	<div class="container kb-structure">
		<div class="kb-structure-tree">
			<?php
			$treeMenu->printMenu();
			?>
		</div>
		<div class="kb-structure-list">
			...
			<img src="../img/blank.gif" width="1" height="16" alt="" style="padding:1px" class="optionWhiteNbOFF" />(<span class="kb_published">1</span>, <span class="kb_private">2</span>, <span class="kb_draft">3</span>) = <?php echo $hesklang['xyz']; ?></span>
		</div>
	</div>
    <?php
}
