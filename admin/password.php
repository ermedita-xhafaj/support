...
?>
<div class="row showTopBar-admin-passwordPhp" style="border-radius: 5px; background-color: #EC790F; font-size: 12px; color: #fff; padding: 5px;">
	<span class="showTopBar"><?php echo $hesklang['login']; ?></span>
</div>

<br/>

<div class="siteUrl-title-admin-passwordPhp">
...
<div align="center">
	<div class="password-reset" style="border: 1px solid black; border-radius: 5px;" width="<?php echo ($hesk_settings['secimg_use']) ? '60' : '50'; ?>% ">
		<div>
			&nbsp;
			<div class="container">
			...
			<div class="form-group">
				<div class="form-inline">
						<img src="../img/login.png" alt="" width="24" height="24" />
				...
				<div class="form-inline">
						&nbsp;
						<label class="control-label" for="email-address-reset-password"><?php echo $hesklang['passe']; ?>:</label><br /><input class="form-control" type="text" id="email-address-reset-password" name="email" size="35" value="<?php if (isset($email)) {echo stripslashes(hesk_input($email));} ?>" <?php echo in_array('email',$_SESSION['a_iserror']) ? ' class="isError" ' : ''; ?> />
				</div>
				<?php
				if ($hesk_settings['secimg_use'])
				{
