...
<!-- start in this page end in line 1431
<tr>
<td>-->
...
<div id="adminTicket-settings-title" class="container"> 
	<?php
	if ($ticket['archive'])
	{
...
<div class="adminTicket-settings">
	<div class="admin-ticket-head1">
		&nbsp;
		<div class="admin-ticket-head2">
			<!-- START TICKET HEAD -->

			<table class="ticket-head">
				<?php
				...
				<div class="form-inline ticket-head-row2">
				<span class="col-sm-2 ticket-head-row2-col1">'.$hesklang['created_on'].': </span>
				<span class="ticket-head-row2-col2">'.hesk_date($ticket['dt'], true).'</span>
				&nbsp;
				</div>

				<div class="form-inline ticket-head-row3">
				<span class="col-sm-2 ticket-head-row3-col1">'.$hesklang['ticket_status'].': </span>
				<span class="ticket-head-row3-col2">';
				...
				<label class="form-inline ticket-head-row2-col2" style="float:right; margin-right: 40px;">
					...
					<input type="submit" value="'.$hesklang['go'].'"class="btn btn-default go-btn" /><input type="hidden" name="track" value="'.$trackingID.'" />
				...
				<div class="form-inline ticket-head-row4">
				<span class="col-sm-2 ticket-head-row4-col1">'.$hesklang['last_update'].': </span>
				<span class="ticket-head-row4-col2">'.hesk_date($ticket['lastchange'], true).'</span>
				&nbsp;
				</div>

				<div class="form-inline ticket-head-row5">
				<span class="col-sm-2 ticket-head-row5-col1">'.$hesklang['category'].': </span>
				<span class="ticket-head-row5-col2">'.$category['name'].'</span>
				<label class=" form-inline ticket-head-row5-col3" style="float:right; margin-right: 40px;">
					';
				...
				<div class="form-inline ticket-head-row6">
				<span class="col-sm-2 ticket-head-row6-col1">'.$hesklang['replies'].': </span>
				<span class="ticket-head-row6-col2">'.$ticket['replies'].'</span>
				&nbsp;
				</div>

				<div class="form-inline ticket-head-row7">
				<span class="col-sm-2 ticket-head-row7-col1">'.$hesklang['priority'].': </span>
				<span class="ticket-head-row7-col2">';
				...
				<label class="ticket-head-row7-col3" style="float:right; margin-right: 40px;">
				...
				<div class="form-inline ticket-head-row8">
				<span class="col-sm-2 ticket-head-row8-col1">'.$hesklang['last_replier'].': </span>
				<span class="ticket-head-row8-col2">'.$ticket['repliername'].'</span>
				&nbsp;
				</div>
				';
				?>
				...
				<div class="hidden form-inline ticket-head-row9">
						...
						<label class="ticket-head-row9-col3" style="float:right; margin-right: 40px;">
							...
							if (hesk_checkPermission('can_assign_others',0))
							{
								...
								<input type="submit" value="<?php echo $hesklang['go']; ?>" class="btn btn-default go-btn"/>
				...
				</div><!-- end form-inline ticket-head-row9 -->
				<?php
				if ($hesk_settings['time_worked'])
				{
				?>
				<div class="form-inline ticket-head-row10">
					<span class="col-sm-2  ticket-head-row10-col1"><?php echo $hesklang['ts']; ?>:</span>

					<?php
					if ($can_reply || $can_edit)
					{
					?>
					<span class="ticket-head-row10-col2"><a href="Javascript:void(0)" onclick="Javascript:hesk_toggleLayerDisplay('modifytime')"><?php echo $ticket['time_worked']; ?></a>
						...
						<div id="modifytime" style="display:none">
							...
							<form method="post" action="admin_ticket.php" style="margin:0px; padding:0px;">
								<div class="white form-inline">
									<div class="form-group">
										<label class="admin_gray" for="h"><?php echo $hesklang['hh']; ?>:</label>
										<input type="text" id="h" name="h" value="<?php echo $t[0]; ?>" size="3" />
									</div>
									<div class="form-group">
										<label class="admin_gray" for="m"><?php echo $hesklang['mm']; ?>:</label>
										<input type="text" id="m" name="m" value="<?php echo $t[1]; ?>" size="3" />
									</div>
									<div class="form-group">
										<label class="admin_gray" for="s"><?php echo $hesklang['ss']; ?>:</label>
										<input type="text" id="s" name="s" value="<?php echo $t[2]; ?>" size="3" />
									</div>
								</div>

								<br />
								<div class="save-cancel-modifytime">
									<input type="submit" value="<?php echo $hesklang['save']; ?>" class="btn btn-default"/>
									|
					...
					{
						echo '<span class="ticket-head-row10-col2">' . $ticket['time_worked'] . '</span>';
					}
					?>
					&nbsp;
				</div><!-- end form-inline ticket-head-row10 -->
				<?php
				} // End if time_worked
				?>

			</table><!-- end ticket-head -->

			<br />

			<div class="table-notemessage-ticket-head">
				<div>
					<span class="col-sm-2" id="notes-ticket-head"><b><i><?php echo $hesklang['notes']; ?>:</i></b></span>

					<?php
					if ($can_reply)
					{
					?>
					<div><a href="Javascript:void(0)" onclick="Javascript:hesk_toggleLayerDisplay('notesform')"><?php echo $hesklang['addnote']; ?></a></div>
					<?php
					}
					?>
						...
						<form method="post" action="admin_ticket.php" style="margin:0px; padding:0px;" enctype="multipart/form-data">
							<div class="form-inline">
								...
								<span class="form-group">
									...
									<input type="submit" value="<?php echo $hesklang['s']; ?>" class="btn btn-default note-btn"><input type="hidden" name="track" value="<?php echo $trackingID; ?>" />
									<input type="hidden" name="token" value="<?php hesk_token_echo(); ?>" />
								</span>
							</div>
						</form>
				...
				<div class="notemessage1" style="background-color: azure; border-radius: 3px; width: 97%;">
						<div class="table-attachment-notemessage">
								<div class="notes"><i><?php echo $hesklang['noteby']; ?> <b><?php echo ($note['name'] ? $note['name'] : $hesklang['e_udel']); ?></b></i> - <?php echo hesk_date($note['dt'], true); ?><br /><img src="../img/blank.gif" border="0" width="5" height="5" alt="" /><br />
								<?php
								// Message
								echo $note['message'];
						...
						</div><!-- end table-attachment-notemessage -->
					<?php
					if ($can_del_notes || $note['who'] == $_SESSION['id'])
					{
					?>
						<div class="pull-right" id="del-notes" style="white-space: nowrap; margin-top: -45px; margin-right: 5px;">
					...
					{
						echo '<div id="del-notes">&nbsp;</div>';
					}
					?>
				</div><!-- end notemessage1-->
				</form>
				<br/>
				<?php
				}
			...
			</div><!-- end table-notemessage-ticket-head-->

			<!-- END TICKET HEAD -->
		</div><!-- end admin-ticket-head2 -->
		&nbsp;
	</div><!-- end admin-ticket-head1 -->
...
?>
		...
		<div class="second-table">
			...
			<!-- START TICKET REPLIES -->
				...
				<div class="table-ticket-replies">
				...
				/*	$color = $i ? 'class="ticketalt"' : 'class="ticketrow"';	*/
					...
					<div class="ticket-replies">
						<div>
							...
							<div class="ticket-replies-info">
								<div>
									<div>
										<div class="form-inline ticket-replies-info-row1">
											<span class="col-sm-2" id="ticket-replies-info-row1-col1"><?php echo $hesklang['date']; ?>:</span>
											<span id="ticket-replies-info-row1-col2"><?php echo hesk_date($ticket['dt'], true); ?></span>
											<span id="ticket-replies-info-row1-col3" style="float: right;  margin-right: 40px;"><?php echo hesk_getAdminButtons(0, $i); ?></span>
										</div><!-- end form-inline ticket-replies-info-row1 -->
										
										<div class="form-inline ticket-replies-info-row2">
											<span class="col-sm-2" id="ticket-replies-info-row2-col1"><?php echo $hesklang['name']; ?>:</span>
											<span id="ticket-replies-info-row2-col2"><?php echo $ticket['name']; ?></span>
										</div><!--end form-inline ticket-replies-info-row2 -->
										
										<div class="form-inline ticket-replies-info-row3">
											<span class="col-sm-2" id="ticket-replies-info-row3-col1"><?php echo $hesklang['email']; ?>:</span>
											<span id="ticket-replies-info-row3-col2"><?php
											if ($can_ban_emails)
											{
											...
											?><a href="mailto:<?php echo $ticket['email']; ?>"><?php echo $ticket['email']; ?></a></span>
										</div><!-- end form-inline ticket-replies-info-row3 -->
										
										<div class="form-inline ticket-replies-info-row4">
											<span class="col-sm-2" id="ticket-replies-info-row4-col1"><?php echo $hesklang['ip']; ?>:</span>
											<span id="ticket-replies-info-row4-col2"><?php
										...
										</div><!-- end form-inline ticket-replies-info-row4 -->
									</div>
									
								</div>
							</div><!-- end ticket-replies-info -->
							...
							<div class="form-inline" id="ticket-replies-message-info">
								<span class="col-sm-2"><?php echo $hesklang['message']; ?>:</span>
								<label class="message-ticketReplies">
								<span id="msg-ticketReplies"><?php echo $ticket['message']; ?></span>
								<label>
							</div>
							...
							if ($hesk_settings['kb_enable'] && $hesk_settings['kb_recommendanswers'] && strlen($ticket['articles']) )
							{
								...
								{
									$suggested_list = '<br/><br/><i>'.$hesklang['taws'].'</i><br />' . $suggested_list . '&nbsp;';
				...
				</div><!-- end table-ticket-replies-->
			<!-- END TICKET REPLIES -->
			</div>
			&nbsp;
		</div>
</div><!-- end admin-ticket-head-settings -->
...
<p>&nbsp;</p>
	...
	<div class="container"><?php echo $hesklang['thist']; ?></div>
	<div class="ticketHistory-admin">
		<ul><?php echo $ticket['history']; ?></ul>
	</div><!-- end ticket-history-admin-ticket.php -->
<?php
}
					...
					<form action="admin_ticket.php" method="get">
						...
						<div id="admin-ticket-view">
							...
							<div id="button-view-ticket">
								&nbsp;
								<button type="submit" class="btn btn-default"><?php echo $hesklang['view_ticket']; ?></button><input type="hidden" name="Refresh" value="<?php echo rand(10000,99999); ?>">
...
<!-- START REPLY FORM -->
	...
	<div class="container addReply-title"><?php echo $hesklang['add_reply']; ?></div>
			...
			?>
				...
				<div class="white table-track-time-worked">
					<div class="form-inline time_worked">
						<label class="col-sm-2"><?php echo $hesklang['ts']; ?></label>					
						<input class="form-control" type="text" name="time_worked" id="time_worked" size="10" value="<?php echo ( isset($_SESSION['time_worked']) ? hesk_getTime($_SESSION['time_worked']) : '00:00:00'); ?>" />
						<button type="button" class="btn btn-default" onclick="ss()" id="startb"><?php echo $hesklang['start']; ?></button>
...
<br/>
			...
			?>
				<div class="white table-track-time-worked">
						<div class="form-inline" style=" margin-bottom: 10px;">
							<span class="admin_gray"><b>&raquo; <?php echo $hesklang['saved_replies']; ?></b></span>
							<div class="form-group admin_gray" style="vertical-align: top;">
								<label for="modeadd"><input type="radio" name="mode" id="modeadd" value="1" checked="checked" /> <?php echo $hesklang['madd']; ?></label><br />
								<label for="moderep"><input type="radio" name="mode" id="moderep" value="0" /> <?php echo $hesklang['mrep']; ?></label>
							</div>
						</div>	
						<div class="form-inline admin_gray" style="margin-bottom: 10px;">
							<label for="selec-canned-response"><?php echo $hesklang['select_saved']; ?>:</label>
			...
			<div class="form-inline">
			<span class="col-sm-2"><?php echo $hesklang['message']; ?>: <font class="important">*</font></span>
...
<br/>
			<div>
				...
				<input type="hidden" name="token" value="<?php hesk_token_echo(); ?>" />
				<input type="submit" value="<?php echo $hesklang['submit_reply']; ?>" class="btn btn-default submit_reply_btn" />
				&nbsp;
				<input type="submit" name="save_reply" value="<?php echo $hesklang['sacl']; ?>" class="btn btn-default sacl_btn" />
			</div>
			<br/>
			...
			if ( ! $ticket['locked'])
			{
				?>
				<div>
					<input type="submit" name="submit_as_customer" value="<?php echo $hesklang['sasc']; ?>" class="btn btn-default sasc_btn" />
					<input type="submit" name="submit_as_resolved" value="<?php echo $hesklang['submit_as'] . ' ' . $hesklang['closed']; ?>" class="btn btn-default submit_as_closed_btn" />
					<input type="submit" name="submit_as_in_progress" value="<?php echo $hesklang['submit_as'] . ' ' . $hesklang['in_progress']; ?>" class="btn btn-default submit_as_in_progress_btn" />
					<input type="submit" name="submit_as_on_hold" value="<?php echo $hesklang['submit_as'] . ' ' . $hesklang['on_hold']; ?>" class="btn btn-default submit_as_on_hold_btn" />
				</div>
				<br/>
				<?php
			}
