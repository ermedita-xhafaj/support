...
switch ($type)
{
	case 'text':
        ...
        <label for="o1">'.$hesklang['custom_l'].':<label>
        <input type="text" name="o1" id="o1" value="'.$maxlen.'" size="30" />
        </div>
        <div class="form-inline" >
        <label for="o2">'.$hesklang['defw'].':<label>
        <input type="text" name="o2" id="o2" value="'.$query.'" size="30" />
        </div>
        </div>
    ...
    case 'textarea':
		...
		<div>
        <div class="form-inline">
        <label for="o1">'.$hesklang['rows'].':<label>
        <input type="text" name="o1" id="o1" value="'.$rows.'" size="5" />
        </div>
        <div class="form-inline">
        <label for="o2">'.$hesklang['cols'].':<label>
        <input type="text" name="o2" id="o2" value="'.$cols.'" size="5" />
        </div>
        </div>
        <p><input type="button" value="  '.$hesklang['ok'].'  " onclick="Javascript:hesk_saveOptions()" /></p>
        ';
    ...
    case 'select':
        ...
        <p>'.$hesklang['opt3'].'</p>
		<p><label for="show_select"><input type="checkbox" name="show_select" id="show_select" value="1" ' . ($show_select ? 'checked="checked"' : '') . ' /> ' . $hesklang['show_select'] . '</label></p>
        <textarea name="o1" id="o1" rows="6" cols="40">'.$options.'</textarea>
        <p><input type="button" value="  '.$hesklang['ok'].'  " onclick="Javascript:hesk_saveOptions()" /></p>
        ';
    	break;
