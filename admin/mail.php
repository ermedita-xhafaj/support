...
<div class="container"><h3><?php echo $hesklang['m_h']; ?></h3></div>
...
function show_message()
{
	...
	<div class="container mail-from-user-table">
		<div>
				...
				<div class="form-inline mail-info-table">
					<div class="form-group mail-from-date-subject">
						<div class="form-inline">
							<span><b><?php echo $hesk_settings['mailtmp']['m_from']; ?></b></span>
							<span><?php echo $pm['name']; ?></span>
						</div>
						<div class="form-inline">
							<span><b><?php echo $hesklang['date']; ?></b></span>
							<span><?php echo $pm['dt']; ?></span>
						</div>
						<div class="form-inline">
							<span><b><?php echo $hesklang['m_sub']; ?></b></span>
							<span><?php echo $pm['subject']; ?></span>
						</div>
			...
			<p><?php echo strip_tags($pm['message']); ?></p>
...
<div class="container mail-new-text-message-table">
	<div>
		<form action="mail.php" method="post" name="form2">
				<div class="container"><h3><?php echo $hesklang['new_mail']; ?></h3></div><br/>
						...
						<div>
							...
							<div class="form-group mail-new-message-to-subject">
								<div class="form-inline" style="margin-bottom: 5px;" >
									<label class="col-sm-2 control-label" for="mail-to"><b><?php echo $hesklang['m_to']; ?></b></label>
								...
								<div class="form-inline">
									<label class="col-sm-2 control-label" for="mail-subject"><b><?php echo $hesklang['m_sub']; ?></b></label>
							...
							<div class="form-inline">
							<label class="col-sm-2 control-label"><b><?php echo $hesklang['message']; ?>:</b></label>
				...
				<input type="submit" value="<?php echo $hesklang['m_send']; ?>" class="btn btn-default mail-btn" />
				</div>
		</form>
		<br/>
	</div>
