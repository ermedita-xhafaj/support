...
function hesk_kb_header($kb_link, $catid=1)
{
	...
	<div class="container manage-view-kb-title">
		...
		{
			?>
			<b><a href="manage_knowledgebase.php"><?php echo $hesklang['kb']; ?></a></b> &gt;
			<?php
		}
		?>
		<?php echo $kb_link; ?>
	...
	<!-- SUB NAVIGATION -->
	<div class="container form-inline view-newa-newc-form"><?php show_subnav('view', $catid); ?></div>
	<!-- SUB NAVIGATION -->
...
function hesk_show_kb_category($catid, $is_search = 0) {
	...
	if (hesk_dbNumRows($result) > 0)
	{
		...
		<div class="container"><b><?php echo $hesklang['kb_cat_sub']; ?>:</b></div><br/>
	...
	<br/>
	<div class="container articles_categ"><b><?php echo $hesklang['ac']; ?></b></div>
