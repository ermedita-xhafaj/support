...
<div class="container tab-content" id="tools-tab">
	...
	<ul id="tabs" class="nav nav-tabs banned-servicemsg-tools" data-tabs="tabs">
		<li class="active" id="banned-email"><a aria-controls="b-email" role="tab" data-toggle="tab" title="<?php echo $hesklang['banemail']; ?>" href="#b-email" onclick="javascript:alert('<?php echo hesk_makeJsString($hesklang['banemail_intro']); ?>')"><?php echo $hesklang['banemail']; ?> [?]</a></li>
		<?php
...
<div class="form-inline table-banned-emails">
	<div>
		<label class="col-sm-2 control-label bananemail-title"><?php echo $hesklang['bananemail']; ?>:</label>
		<div class="col-sm-3"><input class="form-control" type="text" id="banemail" name="email" size="30" maxlength="255" />
...
if ($num < 1)
{
    echo '<br/><div>'.$hesklang['no_banemails'].'</div><br/>';
}
else
{
	// List of staff
	...
	?>
	<div class="perm-email-title"><?php echo $hesklang['eperm']; ?></div>
		<table class="table-responsive table table-bordered perm-email-banned">
			<tr>
