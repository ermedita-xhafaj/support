...
<div class="edit-note-table" style="border: 1px solid black; border-radius: 5px;">
		&nbsp;
		<div class="container">
			...
			<input type="submit" value="<?php echo $hesklang['save_changes']; ?>" class="btn btn-default" /></p>

			</form>

		</div>
		&nbsp;
</div><!-- end edit-note-table -->
