...
<body style="margin:5px 5px; padding:0;">

	<h3><?php echo $hesklang['ful']; ?></h3>

	<div id="filelimits.php">
		<div>
			&raquo;
			<?php echo $hesklang['nat']; ?> <b><?php echo $hesk_settings['attachments']['max_number']; ?></b>
		</div>

		<div>
			&raquo;
			<?php echo $hesklang['mfs']; ?> <b><?php echo hesk_formatBytes($hesk_settings['attachments']['max_size']); ?></b>
		</div>

		<div>
			&raquo;
			<?php echo $hesklang['ufl']; ?>
